...
index 8796cc3..32e6dfe 100644
Original from https://github.com/GNOME/gtk/commit/b366d6c5ffecbc1e786fc4722ca6049e28178f50
...
@@ -363,10 +365,15 @@ _gdk_windowing_get_startup_notify_id (GAppLaunchContext *context,
   else
     workspace_str = NULL;
